        ...
        <div className="animate-fade-in pb-10">
            ...
            <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
                    <h2 className="text-2xl font-bold text-slate-900 mb-5">Provider Information</h2>
                ...
                <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 mt-8">
                    <h2 className="text-2xl font-bold text-slate-900 mb-5">Solutions Summary</h2>
                ...
                <div className="space-y-5 pt-8">
                    <h2 className="text-2xl font-bold text-slate-900">Linked Treatments</h2>
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow className="bg-slate-100/50 hover:bg-slate-100/50">
                                        <TableHead className="text-xs font-semibold text-slate-500 tracking-wider px-6 py-4">
                                            TREATMENT NAME
                                        </TableHead>
                                        <TableHead className="text-xs font-semibold text-slate-500 tracking-wider px-6 py-4">
                                            STATUS
                                    ...
                                    {provider.treatments.map((treatment) => (
                                        <TableRow key={treatment.id} className="hover:bg-slate-50/50">
                                            <TableCell className="px-6 py-4">
                                                <p className="font-medium text-slate-500 text-sm">{treatment.name}</p>
                                            </TableCell>
                                            <TableCell className="px-6 py-4">
                                            ...
                                            <TableCell className="px-6 py-4">
                                                <div className="flex items-center">
                                                    <button
                                                        className="inline-flex items-center justify-center w-8 h-8 rounded-md border border-teal-500 text-teal-600 hover:bg-teal-50 transition-colors"

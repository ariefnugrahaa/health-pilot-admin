...
import { useCreateSupplement } from '@/hooks/use-supplements';
import {
...
interface FormData {
  ...
  // Biomarker criteria
  biomarkerCriteria: { biomarker: string; operator: string; value: string }[];
...
export default function NewSupplementPage() {
  ...
  const validate = (): boolean => {
    ...
    if (!formData.purchaseUrl.trim()) newErrors.purchaseUrl = 'Purchase URL is required';
  ...
  const handleSubmit = async () => {
    ...
    const payload: CreateSupplementPayload = {
      ...
      targetSymptoms: [],
      targetGoals: [],
      targetBiomarkers: formData.biomarkerCriteria.map((b) => b.biomarker),
    ...
    <div className="animate-fade-in pb-10">
      ...
      <div className="bg-white border-b border-slate-200 px-10 py-4 -mx-6 md:-mx-10 mb-6">
        ...
        <p className="text-slate-500 mt-1 text-base">
          Define how this supplement is evaluated, ranked, and displayed in user recommendations.
        </p>
      </div>
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div>
                ...
                <SimpleDropdown
                  ...
                  className={errors.category ? ' [&>button]:border-red-300' : ''}
                />
                {errors.category && (
          ...
          <section>
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-6 space-y-6">
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  <label className="block text-sm font-semibold text-slate-700 mb-2">
                    Retail Type <span className="text-red-500">*</span>
                  </label>
                  <SimpleDropdown
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    className={errors.purchaseUrl ? 'border-red-300' : ''}
                  />
                  {errors.purchaseUrl && (
                    <p className="text-red-500 text-xs mt-1">{errors.purchaseUrl}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    className={errors.affiliateLink ? 'border-red-300' : ''}
                  />
                  {errors.affiliateLink && (
                    <p className="text-red-500 text-xs mt-1">{errors.affiliateLink}</p>
                  )}
                </div>
              </div>
            </div>
